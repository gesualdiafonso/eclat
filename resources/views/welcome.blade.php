<x-layouts.main>
    ...
    <section class="relative h-auto bg-black">
        <div class="relative">
            ...
            <div class="absolute bottom-1/3 text-white w-1/2 py-10 px-16 left-10">
    ...
    <section class="relative h-auto bg-black">
        <div class="relative">
            ...
            <div class="absolute bottom-1/3 text-white w-1/2 py-10 px-16 right-10">
    ...
    {{-- ******************* Modelos ******************* --}}
    <div class="cs-line"></div>
    <section class="mt-10 flex flex-row gap-10 py-10 px-24">
    ...
    <section class="mt-10">
        <div class="cs-line"></div>
        <div class="flex flex-col md:flex-row py-10 px-24">
    ...
    <section class="my-10">
        ...
        {{-- ******************* Blog ******************* --}}
        <section class="my-10 py-10 px-24">
